...
{0x00,0x00,0x7c,0x44,0x7c,0x00},   // Â¬ 0x80 128
{0x00,0x00,0x08,0x7c,0x00,0x00},   // ? 0x81 129
{0x00,0x00,0x64,0x54,0x48,0x00},   // â€š 0x82 130
{0x00,0x00,0x44,0x54,0x28,0x00},   // ďż˝ 0x83 131
{0x00,0x00,0x1c,0x10,0x78,0x00},   // â€ž 0x84 132
{0x00,0x00,0x5c,0x54,0x24,0x00},   // â€¦ 0x85 133
{0x00,0x00,0x78,0x54,0x74,0x00},   // â€  0x86 134
{0x00,0x00,0x64,0x14,0x0c,0x00},   // â€ˇ 0x87 135
{0x00,0x00,0x7c,0x54,0x7c,0x00},   // ďż˝ 0x88 136
{0x00,0x00,0x5c,0x54,0x3c,0x00},   // â€° 0x89 137
{0x00,0x78,0x24,0x26,0x25,0x78},   // Ĺ  0x8a 138
{0x00,0x78,0x25,0x26,0x24,0x78},   // â€ą 0x8b 139
{0x00,0x70,0x2a,0x29,0x2a,0x70},   // Ĺš 0x8c 140
...
{0x00,0x20,0x55,0x54,0x55,0x78},   // â€� 0x91 145
{0x00,0x7c,0x54,0x56,0x55,0x44},   // â€™ 0x92 146
{0x00,0x7c,0x55,0x56,0x54,0x44},   // â€ś 0x93 147
{0x00,0x7c,0x56,0x55,0x56,0x44},   // â€ť 0x94 148
{0x00,0x7c,0x55,0x54,0x55,0x44},   // â€˘ 0x95 149
{0x00,0x38,0x54,0x56,0x55,0x18},   // â€“ 0x96 150
{0x00,0x38,0x55,0x56,0x54,0x18},   // â€” 0x97 151
{0x00,0x38,0x56,0x55,0x56,0x18},   // ďż˝ 0x98 152
{0x00,0x38,0x55,0x54,0x55,0x18},   // â„˘ 0x99 153
{0x00,0x00,0x44,0x7e,0x45,0x00},   // Ĺˇ 0x9a 154
{0x00,0x00,0x45,0x7e,0x44,0x00},   // â€ş 0x9b 155
{0x00,0x00,0x46,0x7d,0x46,0x00},   // Ĺ› 0x9c 156
{0x00,0x00,0x45,0x7c,0x45,0x00},   // ? 0x9d 157
{0x00,0x00,0x48,0x7a,0x41,0x00},   // ~ 0x9e 158
{0x00,0x00,0x49,0x7a,0x40,0x00},   // Ĺş 0x9f 159
{0x00,0x00,0x4a,0x79,0x42,0x00},   //   0xa0 160
{0x00,0x00,0x49,0x78,0x41,0x00},   // Ë‡ 0xa1 161
{0x00,0x38,0x44,0x46,0x45,0x38},   // Ë� 0xa2 162
{0x00,0x38,0x45,0x46,0x44,0x38},   // Ĺ� 0xa3 163
{0x00,0x38,0x46,0x45,0x46,0x38},   // Â¤ 0xa4 164
{0x00,0x38,0x45,0x44,0x45,0x38},   // Ä„ 0xa5 165
{0x00,0x30,0x48,0x4a,0x49,0x30},   // Â¦ 0xa6 166
{0x00,0x30,0x49,0x4a,0x48,0x30},   // Â§ 0xa7 167
{0x00,0x30,0x4a,0x49,0x4a,0x30},   // Â¨ 0xa8 168
{0x00,0x30,0x49,0x48,0x49,0x30},   // Â© 0xa9 169
{0x00,0x3c,0x40,0x42,0x41,0x3c},   // Ĺž 0xaa 170
{0x00,0x3c,0x41,0x42,0x40,0x3c},   // Â« 0xab 171
{0x00,0x3c,0x42,0x41,0x42,0x3c},   // Â¬ 0xac 172
{0x00,0x3c,0x41,0x40,0x41,0x3c},   // Â­  0xad 173
{0x00,0x3c,0x40,0x42,0x21,0x7c},   // Â® 0xae 174
{0x00,0x3c,0x41,0x42,0x20,0x7c},   // Ĺ» 0xaf 175
{0x00,0x38,0x42,0x41,0x22,0x78},   // Â° 0xb0 176
{0x00,0x3c,0x41,0x40,0x21,0x7c},   // Â± 0xb1 177
{0x00,0x4e,0x51,0x71,0x11,0x0a},   // Ë› 0xb2 178
{0x00,0x58,0x64,0x64,0x24,0x10},   // Ĺ‚ 0xb3 179
{0x00,0x7c,0x0a,0x11,0x22,0x7d},   // Â´ 0xb4 180
{0x00,0x78,0x12,0x09,0x0a,0x71},   // Âµ 0xb5 181
{0x00,0x00,0x00,0x04,0x02,0x01},   // Â¶ 0xb6 182
{0x00,0x01,0x02,0x04,0x00,0x00},   // Â· 0xb7 183
{0x00,0x00,0x02,0x00,0x02,0x00},   // Â¸ 0xb8 184
{0x00,0x30,0x48,0x45,0x40,0x20},   // Ä… 0xb9 185
{0x00,0x00,0x00,0x7b,0x00,0x00},   // Ĺź 0xba 186
{0x00,0x38,0x44,0x44,0x38,0x44},   // Â» 0xbb 187
{0x00,0x40,0x3e,0x49,0x49,0x36},   // Ä˝ 0xbc 188
{0x00,0x08,0x04,0x08,0x70,0x0c},   // Ëť 0xbd 189
{0x00,0x60,0x50,0x48,0x50,0x60},   // Äľ 0xbe 190
{0x00,0x20,0x52,0x55,0x59,0x30},   // ĹĽ 0xbf 191
{0x00,0x38,0x54,0x54,0x54,0x00},   // Ĺ” 0xc0 192
{0x00,0x00,0x00,0x7f,0x41,0x00},   // Ă� 0xc1 193
{0x00,0x40,0x22,0x14,0x18,0x60},   // Ă‚ 0xc2 194
{0x00,0x7c,0x20,0x20,0x1c,0x20},   // Ä‚ 0xc3 195
{0x00,0x44,0x3c,0x04,0x7c,0x44},   // Ă„ 0xc4 196
{0x00,0x40,0x3c,0x12,0x12,0x0c},   // Äą 0xc5 197
{0x00,0x41,0x63,0x55,0x49,0x41},   // Ä† 0xc6 198
{0x00,0x38,0x44,0x44,0x3c,0x04},   // Ă‡ 0xc7 199
{0x00,0x08,0x04,0x3c,0x44,0x24},   // ÄŚ 0xc8 200
{0x00,0x08,0x14,0x7f,0x14,0x08},   // Ă‰ 0xc9 201
{0x00,0x4e,0x71,0x01,0x71,0x4e},   // Ä� 0xca 202
{0x00,0x45,0x29,0x11,0x29,0x45},   // Ă‹ 0xcb 203
{0x00,0x0d,0x51,0x51,0x51,0x3d},   // Äš 0xcc 204
{0x00,0x00,0x00,0x05,0x02,0x05},   // ĂŤ 0xcd 205
{0x00,0x40,0x00,0x40,0x00,0x40},   // ĂŽ 0xce 206
{0x00,0x00,0x08,0x1c,0x3e,0x00},   // ÄŽ 0xcf 207
{0x00,0x1c,0x1c,0x1c,0x00,0x00},   // Ä� 0xd0 208
{0x00,0x00,0x70,0x08,0x07,0x00},   // Ĺ� 0xd1 209
{0x00,0x00,0x08,0x08,0x08,0x00},   // Ĺ‡ 0xd2 210
{0x00,0x00,0x1d,0x15,0x17,0x00},   // Ă“ 0xd3 211
{0x00,0x00,0x07,0x05,0x07,0x00},   // Ă” 0xd4 212
{0x00,0x00,0x11,0x15,0x0a,0x00},   // Ĺ� 0xd5 213
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ă– 0xd6 214
{0x00,0x04,0x3c,0x41,0x20,0x00},   // Ă— 0xd7 215
{0x00,0x7c,0x16,0x15,0x16,0x08},   // Ĺ� 0xd8 216
{0x00,0x21,0x16,0x08,0x34,0x42},   // Ĺ® 0xd9 217
{0x00,0x7f,0x09,0x1d,0x01,0x03},   // Ăš 0xda 218
{0x00,0x38,0x54,0x54,0x14,0x08},   // Ĺ° 0xdb 219
{0x00,0x00,0x00,0x7c,0x40,0x40},   // Ăś 0xdc 220
{0x00,0x7f,0x0e,0x1c,0x38,0x7f},   // Ăť 0xdd 221
{0x00,0x41,0x22,0x5d,0x22,0x1c},   // Ĺ˘ 0xde 222
{0x00,0x1c,0x3e,0x1c,0x08,0x00},   // Ăź 0xdf 223
{0x00,0x7f,0x7f,0x7f,0x7f,0x7f},   // Ĺ• 0xe0 224
{0x00,0x77,0x7b,0x01,0x7b,0x77},   // Ăˇ 0xe1 225
{0x00,0x7f,0x43,0x75,0x43,0x7f},   // Ă˘ 0xe2 226
{0x00,0x7f,0x6f,0x55,0x43,0x7f},   // Ä� 0xe3 227
{0x00,0x40,0x40,0x40,0x40,0x40},   // Ă¤ 0xe4 228
{0x00,0x44,0x42,0x5f,0x42,0x44},   // Äş 0xe5 229
{0x00,0x40,0x5e,0x45,0x5e,0x40},   // Ä‡ 0xe6 230
{0x00,0x40,0x48,0x55,0x5e,0x40},   // Ă§ 0xe7 231
{0x00,0x00,0x04,0x08,0x10,0x20},   // ÄŤ 0xe8 232
{0x00,0x03,0x07,0x0e,0x1c,0x38},   // Ă© 0xe9 233
{0x00,0x01,0x03,0x07,0x0f,0x1f},   // Ä™ 0xea 234
{0x00,0x7c,0x78,0x70,0x60,0x40},   // Ă« 0xeb 235
{0x00,0x08,0x08,0x1c,0x22,0x1c},   // Ä› 0xec 236
{0x00,0x00,0x1c,0x22,0x1c,0x00},   // Ă­ 0xed 237
{0x00,0x02,0x00,0x08,0x00,0x20},   // Ă® 0xee 238
{0x00,0x04,0x3e,0x3f,0x3e,0x04},   // ÄŹ 0xef 239
{0x00,0x10,0x3e,0x7e,0x3e,0x10},   // Ä‘ 0xf0 240
{0x00,0x55,0x2a,0x55,0x2a,0x55},   // Ĺ„ 0xf1 241
{0x00,0x24,0x2a,0x7f,0x2a,0x12},   // Ĺ� 0xf2 242
{0x00,0x04,0x1e,0x1f,0x1e,0x04},   // Ăł 0xf3 243
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ă´ 0xf4 244
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ĺ‘ 0xf5 245
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ă¶ 0xf6 246
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ă· 0xf7 247
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ĺ™ 0xf8 248
{0x00,0x00,0x00,0x00,0x00,0x00},   // ĹŻ 0xf9 249
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ăş 0xfa 250
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ĺ± 0xfb 251
{0x00,0x00,0x00,0x00,0x00,0x00},   // ĂĽ 0xfc 252
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ă˝ 0xfd 253
{0x00,0x00,0x00,0x00,0x00,0x00},   // ĹŁ 0xfe 254
{0x00,0x00,0x00,0x00,0x00,0x00}    // Ë™ 0xff 255
};
